...
function Header({
  ...
  return (
    <>
      {window.lg && (
        <header className={`header header-variant-${variant} ${className}`}>
          <div className={`header-body header-${orientation}`}>
            ...
            <nav className="header-nav">
              {links.map((item, index) => {
                ...
                return (
                  <Link key={index} href={item.href} className="header-title">
                    {item.label}
                  </Link>
                );
              })}
      ...
      {window.md && (
        <header
          className={`relative header-mobile  header-variant-${variant}  `}
        >
          <div
